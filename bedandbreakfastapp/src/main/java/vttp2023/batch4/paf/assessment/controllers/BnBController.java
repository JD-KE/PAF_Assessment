...
public class BnBController {
	...
	public ResponseEntity<String> createBooking(@RequestBody String payload) {
		...
		JsonObject bookingDetails = Json.createReader(new StringReader(payload)).readObject();
		Bookings booking = new Bookings();
		booking.setListingId(bookingDetails.getString("id"));
		booking.setName(bookingDetails.getString("name"));
		booking.setEmail(bookingDetails.getString("email"));
		booking.setDuration(bookingDetails.getInt("nights"));
